...
__all__ = ['PhonemeGroupBasedFeatures', 'PhoneticCharNgramsVectorizer', 'generate_phonetic_representation']
...
class PhonemeGroupBasedFeatures(BaseEstimator,TransformerMixin):
    ...
    def transform(self, documents):
        ...
        for doc in documents:
            ...
            homogeneity.append(1 - len(all_phonemes_ctr) / len(all_phonemes))
