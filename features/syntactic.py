...
__all__ = ['POSTags', 'Constituents', 'LexicalizedProduction', 'UnLexicalizedProduction',
           'GrandParentLexicalizedProduction', 'GrandParentUnLexicalizedProduction','WordPOSNGramTfidfVectorizer']
...
class WordPOSNGramTfidfVectorizer(TfidfVectorizer):
    """Convert a collection of  documents objects to a matrix of TF-IDF features.
    ...
    def build_analyzer(self):
        ...
        analyzer = super(TfidfVectorizer,
                         self).build_analyzer()
        return lambda doc: (w for w in analyzer(doc.wordpos))
